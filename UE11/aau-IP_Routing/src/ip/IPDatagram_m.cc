//
// Generated file, do not edit! Created by nedtool 5.2 from src/ip/IPDatagram.msg.
//
...
void IPDatagram::setSrcIP(const inet::IPv4Address& srcIP)
{
    this->srcIP = srcIP;
}
...
IPDatagramDescriptor::IPDatagramDescriptor() : omnetpp::cClassDescriptor("IPDatagram", "omnetpp::cPacket")
{
...
bool IPDatagramDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<IPDatagram *>(obj)!=nullptr;
}

const char **IPDatagramDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *IPDatagramDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *IPDatagramDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int IPDatagramDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *IPDatagramDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string IPDatagramDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool IPDatagramDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *IPDatagramDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 1: return omnetpp::opp_typename(typeid(inet::IPv4Address));
        default: return nullptr;
    };
}

void *IPDatagramDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
